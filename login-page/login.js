...
function handleCreate() {
  ...
  if (!email) {
    showError("createError", "Please enter your email.");
    return;
  }
  if (!isValidEmail(email)) {
  ...
  if (!password) {
    showError("createError", "Please enter a password.");
    return;
  }
...
document.getElementById("createEmail").addEventListener("keydown", (e) => {
